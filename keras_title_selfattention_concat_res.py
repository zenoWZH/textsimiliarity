...
def find_ranking_quick(projection1, projection2, dlmodel):
   ...
   # if bi_lstm_mode == "sum" or bi_lstm_mode == "mul":
    ...
    score_1 = keras.layers.dot([input_1,  input_1], axes = [2,2])
    score_2 = keras.layers.dot([ input_2, input_2], axes = [2,2])
    ...
    ct1 = keras.layers.dot([score_1,  input_1], axes=[2, 1])
    ct2 = keras.layers.dot([score_2, input_2], axes=[2, 1])
...
if __name__ == "__main__":
    ...
    score_1 = keras.layers.dot([lstm_out_1, lstm_out_1], axes = [2,2])
    score_2 = keras.layers.dot([lstm_out_2, lstm_out_2], axes = [2,2])
    #print(K.int_shape(score_1))
   ...
   #print(K.int_shape(at1))
    #ct1 = K.batch_dot(score_1,lstm_out_2, axes=[2, 1])
    #ct2 = K.batch_dot(score_2,lstm_out_1, axes=[2, 1])
    ct1 = keras.layers.dot([score_1, lstm_out_1], axes=[2, 1])
    ct2 = keras.layers.dot([score_2, lstm_out_2], axes=[2, 1])
    #print(K.int_shape(ct1))
