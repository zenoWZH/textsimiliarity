...
def find_ranking_quick(projection1, projection2, dlmodel):
   ...
   # if bi_lstm_mode == "sum" or bi_lstm_mode == "mul":
    ...
    # merged_vector = Dense(dim_lstm*2, activation=att_activation[0])(merged_withatt)
    ...
    model_2.layers[10].set_weights(dlmodel.layers[12].get_weights())
    model_2.layers[12].set_weights(dlmodel.layers[14].get_weights())

    model_2.layers[14].set_weights(dlmodel.layers[16].get_weights())
    ...
    # release memory
    del input_1, input_2, model_1, model_2, lstm_out_1, lstm_out_2, main_output, projection1, projection2, v1, v2, v3, origin_1, origin_2, attout_1, attout_2, merged_1, merged_2, withatt_out_1, withatt_out_2, merged_vector, x1
    gc.collect()
