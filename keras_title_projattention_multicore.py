...
def find_ranking_quick(projection1, projection2, dlmodel):
    ...
    model_1 = multi_gpu_model(model_1, gpus = 4)
   ...
   # if bi_lstm_mode == "sum" or bi_lstm_mode == "mul":
    ...
    #print(K.int_shape(merged_1))
    #merged_1 = Concatenate(axis = 2)(lstm_out_1[:,-1,:],ct1[:,-1,:])
    #merged_2 = Concatenate(axis = 2)(lstm_out_2[:,-1,:],ct2[:,-1,:])
    ...
    model_2 = multi_gpu_model(model_2, gpus = 4)
    # Compile the model
    if mode == "reg":
...
if __name__ == "__main__":
   ...
   #print(K.int_shape(at1))
    ...
    model_lstm2 = multi_gpu_model(model_lstm2,gpus = 4)
